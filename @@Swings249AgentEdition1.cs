...
{
    public class swings249agentedition1 : Indicator
    {
		...
		private bool wasWithinTradingHours; // Correction: Added to track previous bar's state
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Name = "swings249agentedition1";
                Calculate = Calculate.OnBarClose;
                IsOverlay = false; // Correction: This is the correct way to make the indicator appear in a separate panel.
                DisplayInDataBox = true;
                DrawOnPricePanel = false; // Redundant when IsOverlay is false, but harmless.
                ...
                TradingHoursStart = 6; // 6 AM CST
                TradingHoursEnd = 10; // 10 AM CST
                EnableTradingHoursFilter = true;

                // Add plots for separate window display
            ...
            {
                // Indicators are configured here
            }
            else if (State == State.DataLoaded)
            {
                // Correction: All collections and script-managed objects must be initialized here.
        ...
        protected override void OnBarUpdate()
        {
			...
			// Store the previous bar's trading hours state
            ...
            // Check for moving average touches
            CheckMovingAverageTouches();
            
            // Check for early bird signals
        ...
        private void CheckTradingHours()
        {
            ...
            // Correction: Correctly detect the start of a new session
        ...
        private void CheckEarlyBirdSignals()
        {
            ...
            // Early Bird Long Signal: In a bearish context, we suddenly make a HH and HL
            ...
            // Early Bird Short Signal: In a bullish context, we suddenly make a LH and LL
        ...
        {
            // Macro trend based on EMA position
            ...
            else
            {
                ...
                if (latestSignal != null && (Time[0] - latestSignal.Time).TotalMinutes < 5) // Check for recent signals
                {
        ...
        private void DrawIndicator()
        {
            ...
            // Set indicator values for separate window display
            if (!IsOverlay)
            {
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private swings249agentedition1[] cacheswings249agentedition1;
		public swings249agentedition1 swings249agentedition1(int strength, int numSwingsToLabel, int ema200Period, int ema500Period, int ema50Period, int ema20Period, int atrPeriod, double killboxRangeMultiplier, int recentBarsForRange, int tradingHoursStart, int tradingHoursEnd, bool enableTradingHoursFilter)
		{
			return swings249agentedition1(Input, strength, numSwingsToLabel, ema200Period, ema500Period, ema50Period, ema20Period, atrPeriod, killboxRangeMultiplier, recentBarsForRange, tradingHoursStart, tradingHoursEnd, enableTradingHoursFilter);
		}

		public swings249agentedition1 swings249agentedition1(ISeries<double> input, int strength, int numSwingsToLabel, int ema200Period, int ema500Period, int ema50Period, int ema20Period, int atrPeriod, double killboxRangeMultiplier, int recentBarsForRange, int tradingHoursStart, int tradingHoursEnd, bool enableTradingHoursFilter)
		{
			if (cacheswings249agentedition1 != null)
				for (int idx = 0; idx < cacheswings249agentedition1.Length; idx++)
					if (cacheswings249agentedition1[idx] != null && cacheswings249agentedition1[idx].Strength == strength && cacheswings249agentedition1[idx].NumSwingsToLabel == numSwingsToLabel && cacheswings249agentedition1[idx].Ema200Period == ema200Period && cacheswings249agentedition1[idx].Ema500Period == ema500Period && cacheswings249agentedition1[idx].Ema50Period == ema50Period && cacheswings249agentedition1[idx].Ema20Period == ema20Period && cacheswings249agentedition1[idx].AtrPeriod == atrPeriod && cacheswings249agentedition1[idx].KillboxRangeMultiplier == killboxRangeMultiplier && cacheswings249agentedition1[idx].RecentBarsForRange == recentBarsForRange && cacheswings249agentedition1[idx].TradingHoursStart == tradingHoursStart && cacheswings249agentedition1[idx].TradingHoursEnd == tradingHoursEnd && cacheswings249agentedition1[idx].EnableTradingHoursFilter == enableTradingHoursFilter && cacheswings249agentedition1[idx].EqualsInput(input))
						return cacheswings249agentedition1[idx];
			return CacheIndicator<swings249agentedition1>(new swings249agentedition1(){ Strength = strength, NumSwingsToLabel = numSwingsToLabel, Ema200Period = ema200Period, Ema500Period = ema500Period, Ema50Period = ema50Period, Ema20Period = ema20Period, AtrPeriod = atrPeriod, KillboxRangeMultiplier = killboxRangeMultiplier, RecentBarsForRange = recentBarsForRange, TradingHoursStart = tradingHoursStart, TradingHoursEnd = tradingHoursEnd, EnableTradingHoursFilter = enableTradingHoursFilter }, input, ref cacheswings249agentedition1);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.swings249agentedition1 swings249agentedition1(int strength, int numSwingsToLabel, int ema200Period, int ema500Period, int ema50Period, int ema20Period, int atrPeriod, double killboxRangeMultiplier, int recentBarsForRange, int tradingHoursStart, int tradingHoursEnd, bool enableTradingHoursFilter)
		{
			return indicator.swings249agentedition1(Input, strength, numSwingsToLabel, ema200Period, ema500Period, ema50Period, ema20Period, atrPeriod, killboxRangeMultiplier, recentBarsForRange, tradingHoursStart, tradingHoursEnd, enableTradingHoursFilter);
		}

		public Indicators.swings249agentedition1 swings249agentedition1(ISeries<double> input , int strength, int numSwingsToLabel, int ema200Period, int ema500Period, int ema50Period, int ema20Period, int atrPeriod, double killboxRangeMultiplier, int recentBarsForRange, int tradingHoursStart, int tradingHoursEnd, bool enableTradingHoursFilter)
		{
			return indicator.swings249agentedition1(input, strength, numSwingsToLabel, ema200Period, ema500Period, ema50Period, ema20Period, atrPeriod, killboxRangeMultiplier, recentBarsForRange, tradingHoursStart, tradingHoursEnd, enableTradingHoursFilter);
		}
	}
